"""
Food Vision 101 - Utilities Module
==================================

Comprehensive utilities for data processing, model training, evaluation, and visualization.
Combines functionality from helper.py and training_utils.py into one organized module.
